...
#   flon.token <= flon.token::transfer        {"from":"user","to":"flon.rex","quantity":"999.9901 TST","memo":"transfer from user to flon.rex"}
#  flon.reserv <= flon.reserv::powupresult    {"fee":"999.9901 TST","powup_net_weight":"16354","powup_cpu_weight":"65416"}
#          user <= flon.token::transfer        {"from":"user","to":"flon.rex","quantity":"999.9901 TST","memo":"transfer from user to flon.rex"}
#     flon.rex <= flon.token::transfer        {"from":"user","to":"flon.rex","quantity":"999.9901 TST","memo":"transfer from user to flon.rex"}
```
